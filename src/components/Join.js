      ...
      <>
         <div className="wrapper fadeInDown" id="register">
            ...
            <Form onSubmit={this.handleRegister} ref={c => {
              ...
              <Input type="text" id="password" className="form-control fadeIn third" name="password" placeholder="password" validations={[required, vpassword]} onChange={this.onChangePassword}/>
